...
CREATE TABLE `promocoes` (
  ...
  KEY `farm_id` (`farm_id`),
  KEY `med_id` (`med_id`),
  CONSTRAINT `promocoes_ibfk_1` FOREIGN KEY (`farm_id`) REFERENCES `farmacias` (`farm_id`),
  CONSTRAINT `promocoes_ibfk_2` FOREIGN KEY (`med_id`) REFERENCES `medicamentos` (`med_id`)
